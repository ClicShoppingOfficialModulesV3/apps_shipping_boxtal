<?php
  ...
  class zone extends \ClicShopping\Apps\Shipping\Boxtale\Module\ClicShoppingAdmin\Config\ConfigParamAbstract
  {
    public $default = '0';
    ...
    {
      $this->title = $this->app->getDef('cfg_boxtale_mr_zone_title');
      $this->description = $this->app->getDef('cfg_boxtale_mr_zone_desc');
    }
